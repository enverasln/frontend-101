...
function getCategoryButton() {
  return categories.map((category) => `<button onclick="click_categoryButton(event)" class="btn btn-outline-dark btn-item" id=${category}>${category}</button>`).join("");
}

function click_categoryButton(event) {
...
function getCategoryList() {
  btnContainer.innerHTML = getCategoryButton();
};

function getMenuList(menuItems) {
